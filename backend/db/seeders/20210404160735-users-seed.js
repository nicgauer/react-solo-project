...
const randomPicture = () => {
  return pictures[randomNumber(pictures.length - 1)]
}

const userCreator = (amount) => {
  let result = [];
  result.push({
    username: 'Demo',
    email: 'demo@user.com',
    hashedPassword: bcrypt.hashSync('Passw0rd!'),
    pictureURL: 'https://i.imgur.com/sBgJmm8.jpg',
    createdAt: new Date(),
    updatedAt: new Date(),
  })
...
const userArray = userCreator(40);
